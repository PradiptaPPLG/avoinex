<?php $__env->startSection('title', 'Avoinex - Dashboard'); ?>
...
<div class="avx-hero">
    ...
    <video autoplay loop muted playsinline class="avx-hero-bg-video" aria-hidden="true" style="pointer-events: none;">
        <source src="<?php echo e(asset('videos/cinematic-bg.mp4')); ?>" type="video/mp4">
    </video>
    ...
    <main class="avx-main">
        ...
        <div class="avx-rongga" aria-hidden="true">
            <?php if(isset($heroFlashSales) && $heroFlashSales->count() > 0): ?>
            <!-- FLASH SALE HERO BANNER -->
            <div class="avx-flash-hero-container px-4">
                <?php $__currentLoopData = $heroFlashSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flashSale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="avx-flash-card w-100 flex-row justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div class="avx-flash-route text-truncate mb-0" style="font-size: 24px;">
                                <?php echo e($flashSale->flightInstance->schedule->originAirport->iata_code); ?> &rarr; <?php echo e($flashSale->flightInstance->schedule->destinationAirport->iata_code); ?>
                        ...
                        <div class="d-flex align-items-center gap-5">
                            <div class="avx-flash-prices text-end">
                                <span class="avx-flash-original d-block mb-1" style="font-size: 16px;">Rp <?php echo e(number_format($basePrice, 0, ',', '.')); ?></span>
                                <span class="avx-flash-discounted d-block" style="font-size: 32px;">Rp <?php echo e(number_format($discountedPrice, 0, ',', '.')); ?></span>
                            </div>
                            <div class="text-center">
                                <div class="avx-flash-timer avx-countdown mb-2 px-4 py-2" data-endtime="<?php echo e($flashSale->end_time->toIso8601String()); ?>">
                                    <!-- JS WILL FILL THIS -->
                                </div>
                                <div class="avx-flash-seats w-100">
                                    <div class="avx-seat-text justify-content-center <?php echo e($seatColorClass); ?>">
                                        <?php if($remainingSeats < 10): ?> <i class="bi bi-fire"></i> Selling Fast! <?php endif; ?>
                                        <?php echo e($remainingSeats); ?> seats left
                                    </div>
                                    <div class="avx-progress-wrap mx-auto" style="width: 80%;" title="<?php echo e($seatsClaimed); ?> / <?php echo e($totalSeats); ?> claimed">
                                        <div class="avx-progress-bar bg-danger" style="width: <?php echo e($percentage); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="avx-search-card">
                ...
                <form class="avx-search-form" action="<?php echo e(route('flights.search')); ?>" method="GET">
                    ...
                    <div class="avx-search-main">
                        <!-- Dari -->
                        <label class="avx-field position-relative" for="from_display" style="z-index: 10;">
                        ...
                        <div class="avx-swap-container" style="display: flex; align-items: flex-end; justify-content: center; padding-bottom: 8px;">
                            <button type="button" class="avx-swap-btn" id="swapLocationsBtn" aria-label="Swap locations" title="Swap locations">
                                <i class="bi bi-arrow-left-right"></i>
                            </button>
                        </div>

                        <!-- Ke -->
                        <label class="avx-field position-relative" for="to_display" style="z-index: 9;">
        ...
        <section id="avoinex-deals" class="container py-5">
            ...
            <div class="avx-kupon-scroll-container position-relative">
                <div class="avx-kupon-track d-flex gap-4 overflow-auto pb-4 pt-2 px-2" style="scrollbar-width: none;">
                    <?php $__currentLoopData = $secondaryFlashSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $rate = env('USD_TO_IDR', 15500);
                        ...
                        ?>
                        <div class="avx-kupon-card flex-shrink-0 avx-reveal avx-delay-<?php echo e(($loop->index % 5) * 100); ?>">
                            <div class="avx-kupon-top position-relative p-4">
                                <!-- Airline info -->
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    <?php if(isset($deal->flightInstance->schedule->airline->logo_path)): ?>
                                        <img src="<?php echo e(asset('logo_maskapai/' . $deal->flightInstance->schedule->airline->logo_path)); ?>" height="24" alt="Airline">
                                    <?php else: ?>
                                        <span class="badge bg-primary"><?php echo e($deal->flightInstance->schedule->airline_code); ?></span>
                                    <?php endif; ?>
                                    <span class="fw-semibold small text-muted"><?php echo e($deal->flightInstance->schedule->airline->name ?? 'Airlines'); ?></span>
                                </div>
                                
                                <h5 class="fw-bold mb-1 text-dark">
                                    <?php echo e($deal->flightInstance->schedule->originAirport->city); ?> &rarr; <?php echo e($deal->flightInstance->schedule->destinationAirport->city); ?>

                                </h5>
                                <p class="text-muted small mb-3"><?php echo e($deal->flightInstance->flight_date->format('d M Y')); ?></p>
                                
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <span class="badge bg-danger-subtle text-danger px-2 py-1 border-0"><i class="bi bi-clock-history"></i> <span class="avx-countdown" data-endtime="<?php echo e($deal->end_time->toIso8601String()); ?>"></span></span>
                                    <span class="badge bg-warning-subtle text-warning-emphasis border-0"><i class="bi bi-fire"></i> <?php echo e($deal->getRemainingSeats()); ?> Seats Left</span>
                                </div>
                            </div>
                            ...
                            <div class="avx-kupon-bottom p-4 d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="text-decoration-line-through text-muted small d-block" style="font-size: 0.85rem;">Rp <?php echo e(number_format($basePrice, 0, ',', '.')); ?></span>
                                    <span class="text-primary fw-bold fs-5">Rp <?php echo e(number_format($discountedPrice, 0, ',', '.')); ?></span>
                                </div>
                ...
                <?php if($secondaryFlashSales->count() > 3): ?>
...
<?php if(isset($featuredDestinations) && $featuredDestinations->count() > 0): ?>
    <div class="avx-featured-wrapper mt-5">
        <section id="avoinex-featured" class="container py-2">
            
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <?php $__currentLoopData = $featuredDestinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col avx-reveal avx-delay-<?php echo e(($loop->index % 3) * 100); ?>">
                    <div class="avx-featured-card h-100 position-relative bg-white border border-light-subtle shadow-sm flex-column" style="border-radius: 16px; overflow: hidden; display: flex;">
                        ...
                        <div class="position-relative" style="height: 180px;">
                            <img src="<?php echo e(asset($dest->image_path)); ?>" alt="<?php echo e($dest->title); ?>" class="w-100 h-100 object-fit-cover" style="object-fit: cover;">
                            ...
                            <div class="position-absolute top-0 w-100 p-3 d-flex justify-content-between align-items-center" style="background: linear-gradient(to bottom, rgba(0,0,0,0.7), transparent);">
                                <h4 class="mb-0 text-white fw-bold" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.5);"><?php echo e($dest->title); ?></h4>
                                <a href="<?php echo e(route('flights.search', ['from' => $dest->origin_iata, 'to' => $dest->destination_iata, 'tab' => 'promo'])); ?>" class="badge bg-light text-primary text-decoration-none px-3 py-2 rounded-pill fw-bold" style="font-size: 11px;">Jelajahi Penerbangan</a>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-white" style="flex: 1;">
                            <div class="row mb-2">
                                <div class="col-6">
                                    <span class="d-block text-dark fw-bold small"><?php echo e($dest->origin_iata); ?></span>
                                </div>
                                <div class="col-6 text-end">
                                    <span class="d-block text-dark fw-bold small"><?php echo e($dest->destination_iata); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-5">
                                    <span class="text-muted small" style="font-size: 0.8rem;"><?php echo e($dest->date_range); ?></span>
                                </div>
                                <div class="col-7 text-end">
                                    <span class="text-muted small me-1">Mulai dari</span>
                                    <span class="text-warning fw-bold">Rp <?php echo e(number_format($dest->starting_price_usd * env('USD_TO_IDR', 15500), 0, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container mt-2">
            <div class="card">
                <div class="card-header bg-white">
                    <h5 class="mb-0">
                        Available Flights (<?php echo e($flights->count()); ?> found)
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="flight-card ticket-card avx-reveal avx-delay-<?php echo e(($loop->index % 5) * 100); ?>">
                        <div class="ticket-top p-3">
                            ...
                            <div class="col-md-2 text-center d-flex align-items-center justify-content-center">
                                <?php if(isset($flight->schedule->airline->logo_path) && $flight->schedule->airline->logo_path): ?>
                                    <div class="airline-logo rounded-circle shadow-sm overflow-hidden" style="width: 90px; height: 90px; background-color: #fff; border: 2px solid #e0e0e0; display: flex; align-items: center; justify-content: center; padding: 0;">
                                        <img src="<?php echo e(asset('logo_maskapai/' . $flight->schedule->airline->logo_path)); ?>" alt="<?php echo e($flight->airline_name ?? 'Airline'); ?> Logo" style="width: 100%; height: 100%; object-fit: contain; padding: 5px;">
                                    </div>
                                <?php else: ?>
                            ...
                            <div class="col-md-10">
                                <div class="row mb-2">
                                    <div class="col-12">
                                        <h5 class="mb-0 fw-bold"><?php echo e($flight->airline_name ?? 'Garuda Indonesia'); ?></h5>
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3 text-center">
                                        <p class="mb-1"><?php echo e(floor($flight->schedule->duration_minutes / 60)); ?>h <?php echo e($flight->schedule->duration_minutes % 60); ?>m</p>
                                    ...
                                    <div class="col-md-3 text-end" data-available-seats="<?php echo e($flight->available_seats ?? 0); ?>" data-flight-id="<?php echo e($flight->flight_instance_id); ?>">
                                        <?php
                                            $rate = env('USD_TO_IDR', 15500);
                                        ...
                                        <a href="<?php echo e(route('flight.seats', $flight->flight_instance_id)); ?>?adults=1&children=0&infants=0" class="btn btn-primary avx-select-btn avx-seat-link" data-seats="<?php echo e($availableSeats); ?>" data-base-url="<?php echo e(route('flight.seats', $flight->flight_instance_id)); ?>">Select</a>
                                        ...
                                        <small class="text-danger d-block mt-1 avx-seats-warning" style="display:none;">Only <?php echo e($hasFlashSale ? $flashSaleSeats : $availableSeats); ?> <?php echo e($hasFlashSale ? 'promo seat' : 'seat'); ?><?php echo e(($hasFlashSale ? $flashSaleSeats : $availableSeats) != 1 ? 's' : ''); ?> left</small>
                                    </div>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="ticket-bottom p-3">
                            <div class="row">
                                ...
                                <p class="mb-0">
                                    ...
                                    <span class="badge bg-success"><?php echo e(isset($flashSaleSeats) ? $flashSaleSeats . ' promo seats' : $availableSeats . ' seats'); ?> available</span>
                                </p>
                                </div>
                            </div>
                        </div>
...
<section class="container mt-5 mb-5 avx-reveal">
    <div style="background: #ffffff; border-radius: 24px; padding: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.03);">
        ...
        <div style="text-align: center;">
            <img src="<?php echo e(asset('images/maskapai.png')); ?>" class="img-fluid" style="max-width: 100%; border-radius: 8px;" alt="Partner Maskapai Avoinex">
        </div>
    </div>
</section>
...
.avx-search-main {
    display: grid;
    /* Ubah grid ke 6 kolom, kolom 2 untuk swap button */
...
.avx-swap-btn:hover {
    border-color: var(--avx-primary);
    background: #f8fcfd;
    box-shadow: 0 6px 15px rgba(39,158,214,0.15);
...
@media (max-width: 1200px) {
    ...
    .avx-field[for="depart"], .avx-field[for="return"] {
        grid-column: span 1;
    }
...
(function() {
    ...
    var serverTimeStr = "<?php echo e($serverTime ?? now()->toIso8601String()); ?>";
    ...
    // ===== ROBUST DYNAMIC AUTOCOMPLETE =====
    document.querySelectorAll('input[placeholder*="Kota"], input[placeholder*="Bandara"]').forEach(function(input) {
        var wrapper = input.parentElement;
        
        // Find the hidden input sibling (for value submission)
        var hidden = wrapper.querySelector('input[type="hidden"]');
        if (!hidden) return;

        // Ensure parent container has position: relative to anchor absolute dropdown
        var parentContainer = wrapper.closest('label') || wrapper.parentElement;
        if (parentContainer) {
            parentContainer.style.position = 'relative';
            // ensure dropdown is not hidden by z-index stacking
            parentContainer.style.zIndex = parentContainer.style.zIndex || '99';
        }

        // Try to find existing dropdown right after wrapper, or create a new one
        var dropdown = wrapper.nextElementSibling;
        if (!dropdown || !dropdown.classList.contains('avx-autocomplete-dropdown')) {
            dropdown = document.createElement('div');
            dropdown.className = 'avx-autocomplete-dropdown';
            dropdown.style.display = 'none';
            // Adding inline absolute positioning to ensure it renders correctly
            ...
            wrapper.parentNode.insertBefore(dropdown, wrapper.nextSibling);
        }
        ...
        input.addEventListener('input', function() {
            ...
            timeout = setTimeout(function() {
                var apiUrl = '<?php echo e(url('api/airports')); ?>?query=' + encodeURIComponent(query);
                    ...
                    .then(function(data) {
                        ...
                        if (data && data.length > 0) {
                            ...
                            results.forEach(function(airport) {
                                ...
                                item.innerHTML = 
                                    '<div style="font-weight:600;font-size:14px;">' + (airport.code || '') + ' - ' + (airport.city || '') + '</div>' +
    ...
    if (swapBtn) {
        swapBtn.addEventListener('click', function(e) {
            ...
            [fromDisplay.parentElement, toDisplay.parentElement].forEach(el => {
                el.style.borderColor = 'var(--avx-primary)';
                el.style.boxShadow = '0 0 0 4px rgba(39,158,214,0.1)';
                setTimeout(() => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/home.blade.php ENDPATH**/ ?>