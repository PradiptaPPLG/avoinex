<?php $__env->startSection('title', 'Promosi & Kupon Spesial — Avoinex'); ?>
    ...
    <div class="row">
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4 sticky-top" style="top: 100px;">
                ...
                <div class="form-check mb-3">
                    ...
                    <label class="form-check-label d-flex justify-content-between w-100" for="flightsCheck">
                        <span>Flights</span>
                        <span class="text-muted small">(<?php echo e($coupons->count()); ?>)</span>
                    </label>
                </div>
        ...
        <div class="col-lg-9">
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="avx-coupon-item card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                        <div class="avx-coupon-header p-4 text-center" style="background: <?php echo e($coupon->discount_type == 'percentage' ? '#EBF5FF' : '#F0FDF4'); ?>;">
                            <div class="avx-coupon-value display-6 fw-bold mb-0" style="color: <?php echo e($coupon->discount_type == 'percentage' ? '#0066CC' : '#059669'); ?>;">
                                <?php if($coupon->discount_type == 'percentage'): ?>
                                    UP TO <?php echo e(number_format($coupon->discount_value, 0)); ?>%
                                <?php else: ?>
                                    Rp <?php echo e(number_format($coupon->discount_value / 1000, 0)); ?>rb
                                <?php endif; ?>
                            </div>
                            <div class="small fw-bold opacity-75">OFF FLIGHTS</div>
                        </div>
                        <div class="card-body p-4 d-flex flex-column">
                            <h5 class="fw-bold mb-2"><?php echo e($coupon->title); ?></h5>
                            <p class="text-muted small mb-3"><?php echo e($coupon->description); ?></p>
                            
                            <div class="mt-auto">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="badge bg-light text-muted fw-normal">Expires in <?php echo e($coupon->end_date->diffForHumans()); ?></span>
                                    <span class="text-primary fw-bold small">Min. spend Rp <?php echo e(number_format($coupon->min_spend / 1000, 0)); ?>rb</span>
                                </div>
                                <button class="btn btn-primary w-100 rounded-pill fw-bold avx-claim-btn" data-code="<?php echo e($coupon->code); ?>">
                                    CLAIM COUPON
                                </button>
                            </div>
                        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <a href="<?php echo e($banner->link_url ?? '#'); ?>" class="avx-promo-wide card border-0 shadow-sm rounded-4 overflow-hidden text-decoration-none">
                        <div class="row g-0">
                            <div class="col-md-5">
                                <img src="<?php echo e(asset('storage/' . $banner->image_path)); ?>" class="img-fluid w-100 h-100 object-fit-cover" alt="<?php echo e($banner->title); ?>" style="min-height: 200px;">
                            </div>
                            <div class="col-md-7">
                                <div class="card-body p-4 h-100 d-flex flex-column justify-content-center">
                                    ...
                                    <h4 class="fw-bold text-dark mb-2"><?php echo e($banner->title); ?></h4>
                                    <p class="text-muted mb-4"><?php echo e($banner->subtitle); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/pages/deals.blade.php ENDPATH**/ ?>