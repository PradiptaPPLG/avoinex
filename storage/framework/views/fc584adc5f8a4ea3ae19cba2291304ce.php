...
<div class="chatbot-widget-wrapper" id="chatbotWidgetWrapper">
    ...
    <div class="chatbot-widget-btn" id="chatbotWidgetBtn" aria-label="Open AI Assistant">
        ...
        <link rel="preload" href="<?php echo e($currentAi['avatar']); ?>" as="image">
        <link rel="preload" href="<?php echo e($currentAi['avatar_blink']); ?>" as="image">
        <!-- Main avatar image for the widget button -->
        <img src="<?php echo e($currentAi['avatar']); ?>" alt="<?php echo e($currentAi['name']); ?> Assistant" id="chatbotAvatarBtn">
    </div>
</div>
...
<div class="chatbot-window" id="chatbotWindow">
    <div class="chatbot-header">
        <div class="chatbot-header-info">
            <div class="chatbot-header-avatar">
                ...
                <img src="<?php echo e($currentAi['avatar']); ?>" alt="<?php echo e($currentAi['name']); ?>" id="chatbotAvatarHeader">
            </div>
            <div>
                <h3 class="chatbot-title"><?php echo e($currentAi['name']); ?></h3>
                <p class="chatbot-status" id="chatbotStatus"><?php echo e($currentAi['title']); ?></p>
            </div>
        </div>
        <a href="<?php echo e(route('ai-models')); ?>" class="chatbot-close" id="chatbotSettingsBtn" aria-label="AI Settings"><i class="bi bi-gear"></i></a>
    </div>
    
    <div class="chatbot-body" id="chatbotBody">
        <div class="chat-msg bot"><?php echo e($currentAi['greeting']); ?></div>
        <!-- Typing indicator -->
    ...
    <div class="chatbot-footer">
        <input type="text" class="chatbot-input" id="chatbotInput" placeholder="Tulis pesan ke <?php echo e($currentAi['name']); ?>..." autocomplete="off">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const frame1 = "<?php echo e($currentAi['avatar']); ?>";
        const frame2 = "<?php echo e($currentAi['avatar_blink']); ?>";
        ...
        async function sendToAPI(message, retriesLeft) {
            try {
                ...
                const response = await fetch('<?php echo e(url('/api/chat')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/chatbot.blade.php ENDPATH**/ ?>