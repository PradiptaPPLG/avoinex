...
<div class="chatbot-widget-wrapper" id="chatbotWidgetWrapper">
    ...
    <div class="chatbot-widget-btn" id="chatbotWidgetBtn" aria-label="Open AI Assistant">
        ...
        <link rel="preload" href="<?php echo e(asset('images/vanessa.png')); ?>" as="image">
        <link rel="preload" href="<?php echo e(asset('images/vanessa02.png')); ?>" as="image">
        <!-- Main avatar image for the widget button -->
        <img src="<?php echo e(asset('images/vanessa.png')); ?>" alt="Vanessa Assistant" id="chatbotAvatarBtn">
    </div>
</div>
    ...
    <div class="chatbot-header">
        <div class="chatbot-header-info">
            <div class="chatbot-header-avatar">
                ...
                <img src="<?php echo e(asset('images/vanessa.png')); ?>" alt="Vanessa" id="chatbotAvatarHeader">
            </div>
            <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const frame1 = "<?php echo e(asset('images/vanessa.png')); ?>";
        const frame2 = "<?php echo e(asset('images/vanessa02.png')); ?>";
