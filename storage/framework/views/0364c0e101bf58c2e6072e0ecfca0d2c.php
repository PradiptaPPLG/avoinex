...
<body>
    ...
    <div class="forgot-card">
        ...
        <form action="<?php echo e(route('admin.password.send-code')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label class="form-label">Email Pemulihan</label>
                <div class="input-icon-wrap">
                    <i class="bi bi-envelope"></i>
                    <input type="email" name="email" class="form-control" placeholder="Masukkan email pemulihan" required value="<?php echo e(old('email')); ?>" autofocus>
                </div>
            </div>
        ...
        <a href="<?php echo e(route('admin.login')); ?>" class="back-link">
...
<?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/admin/forgot-password.blade.php ENDPATH**/ ?>