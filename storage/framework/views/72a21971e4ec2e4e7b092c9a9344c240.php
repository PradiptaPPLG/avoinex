    ...
    <?php $__env->startSection('title', 'Create Flight Instance'); ?>
    <?php $__env->startSection('page-title', 'Create Flight Instance'); ?>
            ...
            <form action="<?php echo e(route('admin.flights.store')); ?>" method="POST">
                ...
                <div class="d-flex flex-column gap-4">
                    <div>
                        ...
                        <select name="schedule_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($schedule->schedule_id); ?>"><?php echo e($schedule->flight_number); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="aircraft_instance_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $aircraftInstances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($instance->aircraft_instance_id); ?>">
                                    <?php echo e($instance->aircraft->registration_number ?? 'N/A'); ?> — <?php echo e($instance->aircraft->aircraft_model ?? 'N/A'); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="flight_date" class="form-control" required value="<?php echo e(old('flight_date')); ?>">
                    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/admin/flights/create.blade.php ENDPATH**/ ?>