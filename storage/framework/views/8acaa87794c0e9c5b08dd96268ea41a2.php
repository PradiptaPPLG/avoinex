<?php $__env->startSection('title', 'My Profile - Avoinex'); ?>
                ...
                <div class="avx-profile-card">
                    ...
                    <div class="avx-profile-avatar-wrapper">
                        <div class="avx-profile-avatar">
                            <span><?php echo e(strtoupper(substr($client->first_name ?? 'U', 0, 1))); ?><?php echo e(strtoupper(substr($client->last_name ?? 'X', 0, 1))); ?></span>
                        </div>
                    </div>
                    <div class="avx-profile-info">
                        <h4 class="avx-profile-name"><?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?></h4>
                        <p class="avx-profile-email"><i class="bi bi-envelope me-1"></i><?php echo e($client->email); ?></p>
                        <?php if($client->phone): ?>
                            <p class="avx-profile-phone"><i class="bi bi-phone me-1"></i><?php echo e($client->phone); ?></p>
                        <?php endif; ?>
                        <div class="avx-profile-member-since">
                            <i class="bi bi-calendar3 me-1"></i>Member sejak <?php echo e($client->created_at ? $client->created_at->format('M Y') : 'N/A'); ?>
                    ...
                    <div class="avx-profile-stats">
                        <div class="avx-stat-item">
                            <div class="avx-stat-number"><?php echo e($totalBookings); ?></div>
                            <div class="avx-stat-label">Total Booking</div>
                        </div>
                        <div class="avx-stat-item">
                            <div class="avx-stat-number" style="color: #0DAF7A;"><?php echo e($confirmedBookings); ?></div>
                            <div class="avx-stat-label">Confirmed</div>
                        </div>
                        <div class="avx-stat-item">
                            <div class="avx-stat-number" style="color: #279ED6;">Rp <?php echo e(number_format($totalSpent, 0, ',', '.')); ?></div>
            ...
            <div class="col-lg-8">
                        ...
                        <form action="<?php echo e(route('profile.update')); ?>" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="first_name" class="avx-form-control" value="<?php echo e(old('first_name', $client->first_name)); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="avx-form-label">Nama Belakang</label>
                                    <input type="text" name="last_name" class="avx-form-control" value="<?php echo e(old('last_name', $client->last_name)); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="avx-form-label">Email</label>
                                    <input type="email" class="avx-form-control" value="<?php echo e($client->email); ?>" disabled>
                                    <small class="text-muted">Email tidak bisa diubah</small>
                                </div>
                                <div class="col-md-6">
                                    <label class="avx-form-label">Nomor Telepon</label>
                                    <input type="text" name="phone" class="avx-form-control" value="<?php echo e(old('phone', $client->phone)); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="avx-form-label">Tanggal Lahir</label>
                                    <input type="date" name="date_of_birth" class="avx-form-control" value="<?php echo e(old('date_of_birth', $client->date_of_birth)); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label class="avx-form-label">Passport</label>
                                    <input type="text" class="avx-form-control" value="<?php echo e($client->passport ?? '-'); ?>" disabled>
                ...
                <div class="avx-form-card mt-4">
                    <div class="avx-form-card-header">
                        ...
                        <a href="<?php echo e(route('booking.index')); ?>" class="avx-view-all">Lihat Semua →</a>
                    </div>
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp <?php echo e(number_format($booking->total_price_usd, 0, ',', '.')); ?></td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <span class="badge bg-danger"><?php echo e(ucfirst($booking->booking_status)); ?></span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/pages/profile.blade.php ENDPATH**/ ?>