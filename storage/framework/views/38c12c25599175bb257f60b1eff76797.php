...
<div class="row">
    <div class="col-lg-8">
        <form action="<?php echo e(route('admin.banners.store')); ?>" method="POST" enctype="multipart/form-data" class="card border-0 shadow-sm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g. Summer Vacation Deals" value="<?php echo e(old('title')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="e.g. Save up to 20% on all flights" value="<?php echo e(old('subtitle')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Enter more details about this promo..."><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="https://avoinex.com/promo/summer" value="<?php echo e(old('link_url')); ?>">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/admin/banners/create.blade.php ENDPATH**/ ?>