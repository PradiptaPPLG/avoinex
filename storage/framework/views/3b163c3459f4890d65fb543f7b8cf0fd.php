...
<?php $__env->startSection('page-title', 'Refund Requests'); ?>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div class="d-flex align-items-center gap-2">
            ...
            <?php if($refundRequests->total() > 0): ?>
                <span class="badge bg-warning text-dark"><?php echo e($refundRequests->total()); ?> menunggu</span>
            <?php endif; ?>
        </div>
    ...
    <div class="card-body p-0">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $refundRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="border-bottom p-4">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <div style="font-weight: 600;"><?php echo e($booking->client->first_name); ?> <?php echo e($booking->client->last_name); ?></div>
                ...
                <div class="col-md-3">
                    ...
                    <div style="font-weight: 600;">
                        <?php echo e($booking->flightInstance->schedule->originAirport->iata_code); ?> → <?php echo e($booking->flightInstance->schedule->destinationAirport->iata_code); ?>

                    </div>
                    <div style="font-size: 12px; color: var(--text-muted);">
                        <?php echo e($booking->flightInstance->flight_date->format('d M Y')); ?>
                ...
                <div class="col-md-3">
                    ...
                    <div style="font-weight: 700; font-size: 18px; color: var(--success);">
                        Rp <?php echo e(number_format($booking->total_price_usd, 0, ',', '.')); ?>

                    </div>
                    <div style="font-size: 11px; color: var(--text-muted);">
                        <?php echo e($booking->bookingSeats->count()); ?> penumpang
                    </div>
                </div>
            </div>
            ...
            <div class="p-3 rounded mb-3" style="background: #FFF8E1; border: 1px solid #FFE082;">
                ...
                <div style="font-size: 14px; color: #333;"><?php echo e($booking->refund_reason); ?></div>
                <div style="font-size: 11px; color: var(--text-muted); margin-top: 6px;">
                    <i class="bi bi-clock me-1"></i> Diminta pada: <?php echo e($booking->refund_requested_at->format('d M Y H:i')); ?>

                    (<?php echo e($booking->refund_requested_at->diffForHumans()); ?>)
                </div>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <?php $calc = $booking->calculateRefundAmount(); ?>
                    <form action="<?php echo e(route('admin.bookings.refund.process', $booking->booking_id)); ?>" method="POST"
                        class="p-3 rounded h-100" style="background: #E8F5E9; border: 1px solid #A5D6A7;"
                        onsubmit="return confirm('Yakin ingin MENYETUJUI refund otomatis senilai Rp <?php echo e(number_format($calc['amount'], 0, ',', '.')); ?>?')">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3 p-2 rounded" style="background: rgba(255,255,255,0.5); border: 1px dashed #A5D6A7;">
                            <div class="row g-2 text-center">
                                <div class="col-6 border-end">
                                    ...
                                    <div style="font-weight: 700; color: #2E7D32;">Rp <?php echo e(number_format($calc['amount'], 0, ',', '.')); ?></div>
                                </div>
                                <div class="col-6">
                                    <div style="font-size: 11px; color: #666;">Kebijakan</div>
                                    <div style="font-weight: 700; color: #2E7D32;"><?php echo e($calc['percentage']); ?>% (<?php echo e(ceil($calc['hours_remaining'])); ?> jam lagi)</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <form action="<?php echo e(route('admin.bookings.refund.process', $booking->booking_id)); ?>" method="POST"
                        ...
                        onsubmit="return confirm('Yakin ingin MENOLAK refund untuk <?php echo e($booking->booking_code); ?>?')">
                        <?php echo csrf_field(); ?>
        ...
        <div class="text-center py-5">
            ...
            <div class="mt-2">
                <a href="<?php echo e(route('admin.bookings.index')); ?>" class="btn btn-sm btn-outline-primary">Lihat Semua Bookings</a>
            </div>
        </div>
        <?php endif; ?>

        <?php if($refundRequests->hasPages()): ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/admin/bookings/refunds.blade.php ENDPATH**/ ?>