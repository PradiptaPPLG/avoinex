            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="background:#eef7fc; border:2px dashed #279ED6; border-radius:12px; padding:20px; text-align:center;">
                        ...
                        <p style="margin:0; font-size:32px; font-weight:800; color:#279ED6; letter-spacing:3px;"><?php echo e($booking->booking_code); ?></p>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="text-align:left; width:40%;">
                        ...
                        <p style="margin:4px 0 0; font-size:24px; font-weight:800; color:#222;"><?php echo e($booking->flightInstance->schedule->originAirport->iata_code); ?></p>
                        <p style="margin:2px 0 0; font-size:13px; color:#666;"><?php echo e($booking->flightInstance->schedule->originAirport->city); ?></p>
                    </td>
                    ...
                    <td style="text-align:right; width:40%;">
                        ...
                        <p style="margin:4px 0 0; font-size:24px; font-weight:800; color:#222;"><?php echo e($booking->flightInstance->schedule->destinationAirport->iata_code); ?></p>
                        <p style="margin:2px 0 0; font-size:13px; color:#666;"><?php echo e($booking->flightInstance->schedule->destinationAirport->city); ?></p>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fa; border-radius:10px; padding:16px;">
                <tr>
                    <td style="padding:12px 16px; width:33%;">
                        ...
                        <p style="margin:4px 0 0; font-size:15px; font-weight:700; color:#222;"><?php echo e($booking->flightInstance->schedule->flight_number); ?></p>
                    </td>
                    <td style="padding:12px 16px; width:33%;">
                        <p style="margin:0; font-size:11px; color:#999; text-transform:uppercase;">Date</p>
                        <p style="margin:4px 0 0; font-size:15px; font-weight:700; color:#222;"><?php echo e($booking->flightInstance->flight_date->format('d M Y')); ?></p>
                    </td>
                    <td style="padding:12px 16px; width:33%;">
                        <p style="margin:0; font-size:11px; color:#999; text-transform:uppercase;">Departure</p>
                        <p style="margin:4px 0 0; font-size:15px; font-weight:700; color:#222;"><?php echo e(date('H:i', strtotime($booking->flightInstance->schedule->departure_time_gmt))); ?></p>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td style="padding:20px 40px 0;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fa; border-left:4px solid #279ED6; padding:12px 16px;">
                <tr>
                    <td>
                        <p style="margin:0; font-size:13px; color:#555;">Name: <strong style="color:#222;"><?php echo e($booking->client->first_name); ?> <?php echo e($booking->client->last_name); ?></strong></p>
                        <p style="margin:4px 0; font-size:13px; color:#555;">Email: <strong style="color:#222;"><?php echo e($booking->client->email); ?></strong></p>
                        <p style="margin:0; font-size:13px; color:#555;">Phone: <strong style="color:#222;"><?php echo e($booking->client->phone); ?></strong></p>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td style="padding:20px 40px;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                ...
                <?php $__currentLoopData = $booking->bookingSeats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bSeat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="background:<?php echo e($index % 2 == 0 ? '#f8f9fa' : '#ffffff'); ?>;">
                    <td style="padding:12px 14px; font-size:13px; color:#333; border-bottom:1px solid #eee;">
                        <?php echo e($bSeat->passenger_first_name); ?> <?php echo e($bSeat->passenger_last_name); ?>

                    </td>
                    <td style="padding:12px 14px; font-size:13px; color:#333; text-align:center; border-bottom:1px solid #eee;">
                        <strong><?php echo e($bSeat->seat->seat_number ?? 'N/A'); ?></strong>
                    </td>
                    <td style="padding:12px 14px; font-size:13px; color:#333; text-align:center; border-bottom:1px solid #eee;">
                        <?php echo e($bSeat->baggage_weight ?? 0); ?>kg
                    </td>
                    <td style="padding:12px 14px; font-size:13px; color:#333; text-align:right; border-bottom:1px solid #eee;">
                        Rp <?php echo e(number_format(($bSeat->price_at_booking + ($bSeat->baggage_price ?? 0)) * 15500, 0, ',', '.')); ?>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#eef7fc; border-radius:10px;">
                <tr>
                    ...
                    <td style="padding:16px 20px; text-align:right;">
                        <p style="margin:0; font-size:24px; font-weight:800; color:#279ED6;">Rp <?php echo e(number_format($booking->total_price_usd * 15500, 0, ',', '.')); ?></p>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td style="padding:0 40px 28px; text-align:center;">
            <span style="display:inline-block; background:#d4edda; color:#155724; padding:8px 24px; border-radius:20px; font-size:13px; font-weight:700; letter-spacing:0.5px;">
                ✓ <?php echo e(strtoupper($booking->booking_status)); ?> — <?php echo e(strtoupper($booking->payment_status)); ?>
...
<?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/emails/booking_confirmation.blade.php ENDPATH**/ ?>