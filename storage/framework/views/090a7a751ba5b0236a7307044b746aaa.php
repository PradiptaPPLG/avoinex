            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                ...
                <tr style="background:<?php echo e($index % 2 == 0 ? '#f8f9fa' : '#ffffff'); ?>;">
                    ...
                    <td style="padding:12px 14px; font-size:13px; color:#333; text-align:right; border-bottom:1px solid #eee;">
                        Rp <?php echo e(number_format($bSeat->price_at_booking + ($bSeat->baggage_price ?? 0), 0, ',', '.')); ?>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#eef7fc; border-radius:10px;">
                <tr>
                    ...
                    <td style="padding:16px 20px; text-align:right;">
                        <p style="margin:0; font-size:24px; font-weight:800; color:#279ED6;">Rp <?php echo e(number_format($booking->total_price_usd, 0, ',', '.')); ?></p>
                    </td>
                </tr>
            </table>
        </td>
