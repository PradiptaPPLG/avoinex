...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Avoinex - Flight Reservation'); ?></title>
...
<header class="avx-topbar">
    <div class="avx-left">
        ...
        <span class="avx-currency-block">
            <img src="<?php echo e(asset('images/bendera.png')); ?>" class="avx-flag-img">
            IDR | ID
        </span>
        <?php endif; ?>
    </div>
        ...
        <?php if(session('client_id')): ?>
            ...
            <div class="avx-user-profile-wrapper" onclick="event.stopPropagation(); document.getElementById('userDropdown').classList.toggle('show');">
                ...
                <div class="avx-user-dropdown" id="userDropdown">
                    <a href="<?php echo e(route('home')); ?>" class="avx-dropdown-item">
                    ...
                    <a href="<?php echo e(route('profile')); ?>" class="avx-dropdown-item">
        ...
        <div class="avx-modal-card" role="presentation">
            <div class="avx-modal-header">
                <div class="avx-logo-wrap">
                    <img src="<?php echo e(asset('images/iconfix.png')); ?>" alt="Avoinex" class="avx-modal-logo">
                </div>
            ...
            <div class="avx-modal-body">
                <?php if(session('error')): ?>
                    <div class="avx-alert-error"><?php echo e(session('error')); ?></div>
                <?php endif; ?>

                <!-- Google button: white with #787878 outline 1px, narrower -->
                <a href="<?php echo e(route('google.redirect')); ?>" class="avx-btn avx-btn-social avx-btn-google" aria-label="Continue with Google">
                    <!-- google svg -->
                ...
                <div id="emailLoginForm" class="avx-form-block" style="display: none; margin-top: 20px;">
                    <form action="<?php echo e(route('login.submit')); ?>" method="POST" novalidate>
                        ...
                        <div class="avx-form-options">
                            ...
                            <a href="<?php echo e(route('password.forgot')); ?>" class="avx-forgot-link">Forgot password?</a>
                        </div>
...
(function(){
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        <?php if(session('logout_message')): ?>
            const notification = document.createElement('div');
            notification.className = 'avx-logout-message';
            notification.textContent = '<?php echo e(session("logout_message")); ?>';
            document.body.appendChild(notification);
    ...
    <div class="avx-footer-main">
        ...
        <div class="avx-footer-brand">
            ...
            <div class="avx-footer-socials">
                ...
                <a href="<?php echo e($siteSettings['social_instagram']); ?>" target="_blank" rel="noopener" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                <?php endif; ?>
                <?php if(!empty($siteSettings['social_facebook']) && $siteSettings['social_facebook'] !== '#'): ?>
                <a href="<?php echo e($siteSettings['social_facebook']); ?>" target="_blank" rel="noopener" aria-label="Facebook"><i class="bi bi-facebook"></i></a>
                <?php endif; ?>
                <?php if(!empty($siteSettings['social_twitter']) && $siteSettings['social_twitter'] !== '#'): ?>
                <a href="<?php echo e($siteSettings['social_twitter']); ?>" target="_blank" rel="noopener" aria-label="Twitter"><i class="bi bi-twitter-x"></i></a>
                <?php endif; ?>
                <?php if(!empty($siteSettings['social_youtube']) && $siteSettings['social_youtube'] !== '#'): ?>
                <a href="<?php echo e($siteSettings['social_youtube']); ?>" target="_blank" rel="noopener" aria-label="YouTube"><i class="bi bi-youtube"></i></a>
                <?php endif; ?>
                <?php if(!empty($siteSettings['social_tiktok']) && $siteSettings['social_tiktok'] !== '#'): ?>
                <a href="<?php echo e($siteSettings['social_tiktok']); ?>" target="_blank" rel="noopener" aria-label="TikTok"><i class="bi bi-tiktok"></i></a>
                <?php endif; ?>
                <?php if(!empty($siteSettings['social_whatsapp']) && $siteSettings['social_whatsapp'] !== '#'): ?>
                <a href="<?php echo e($siteSettings['social_whatsapp']); ?>" target="_blank" rel="noopener" aria-label="WhatsApp"><i class="bi bi-whatsapp"></i></a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div>
            ...
            <ul class="avx-footer-links">
                ...
                <li><a href="<?php echo e(route('deals')); ?>"><i class="bi bi-chevron-right"></i> Promo & Deals</a></li>
                <li><a href="<?php echo e(route('booking.find.form')); ?>"><i class="bi bi-chevron-right"></i> Cek Booking</a></li>
                <li><a href="<?php echo e(route('support')); ?>"><i class="bi bi-chevron-right"></i> Pusat Bantuan</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <div class="avx-footer-contact-item">
                ...
                <div class="avx-footer-contact-text">
                    <span>Kantor</span>
                    <?php echo e($siteSettings['contact_address']); ?>
    ...
    <div class="avx-footer-bottom">
        <div class="avx-footer-bottom-inner">
            <div class="avx-footer-copyright">
                <?php echo e($siteSettings['footer_copyright'] ?? '© 2026 Avoinex Airlines. All Rights Reserved.'); ?>
        ...
        <div class="avx-modal-container" role="document" tabindex="-1" style="width: 1000px; max-width: 95vw;">
            ...
            <div class="avx-modal-card avx-modal-animate" style="padding: 50px; border-radius: 64px; position: relative; background: #fff;">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        <div class="ai-card <?php echo e($activeAi == 'vanessa' ? 'active' : ''); ?>" onclick="selectAi('vanessa')" style="
                            border: <?php echo e($activeAi == 'vanessa' ? '2px solid #279ED6' : '1px solid #e2e8f0'); ?>;
                            border-radius: 32px;
                            padding: 30px 20px;
                            text-align: center;
                            position: relative;
                        ...
                        ">
                            ...
                            <?php endif; ?>
                            <img src="<?php echo e(asset('images/vanessa02.png')); ?>" alt="Vanessa" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 20px; border: 4px solid #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.12);">
                    ...
                    <div class="col-md-3">
                        ...
                        ">
                            ...
                            <img src="<?php echo e(asset('images/sofia.png')); ?>" alt="Sofia" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 20px; box-shadow: 0 8px 20px rgba(0,0,0,0.08);">
                    ...
                    <div class="col-md-3">
                        ...
                        ">
                            <div class="badge bg-secondary position-absolute" style="top: 15px; right: 15px; font-size: 10px; padding: 5px 10px; border-radius: 20px; background: #94a3b8 !important;">SOON</div>
                            <img src="<?php echo e(asset('images/serena.png')); ?>" alt="Serena" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 20px; box-shadow: 0 8px 20px rgba(0,0,0,0.08);">
                    ...
                    <div class="col-md-3">
                        ...
                        ">
                            ...
                            <img src="<?php echo e(asset('images/lucy.png')); ?>" alt="Lucy" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 20px; box-shadow: 0 8px 20px rgba(0,0,0,0.08);">
