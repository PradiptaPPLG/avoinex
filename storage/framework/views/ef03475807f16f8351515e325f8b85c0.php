...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo, <strong><?php echo e($booking->client->first_name); ?> <?php echo e($booking->client->last_name); ?></strong>,</p>
            
            <p>Kami telah meninjau permintaan refund Anda untuk kode booking <strong><?php echo e($booking->booking_code); ?></strong>.</p>
            ...
            <?php if($status === 'approved'): ?>
                ...
                <div class="details">
                    ...
                    <table width="100%">
                        <tr><td>Total Bayar:</td><td align="right">Rp <?php echo e(number_format($booking->total_price_usd, 0, ',', '.')); ?></td></tr>
                        <tr><td>Nominal Refund:</td><td align="right"><strong>Rp <?php echo e(number_format($booking->refund_amount_usd, 0, ',', '.')); ?></strong></td></tr>
                        <?php if($booking->refund_admin_notes): ?>
                        <tr><td colspan="2" style="padding-top:10px; border-top:1px solid #ddd;"><strong>Catatan Admin:</strong><br><?php echo e($booking->refund_admin_notes); ?></td></tr>
                        <?php endif; ?>
                    </table>
                </div>
            ...
            <?php else: ?>
                ...
                <div class="details">
                    ...
                    <?php echo e($booking->refund_admin_notes ?? 'Tidak ada catatan tambahan.'); ?>
            ...
            <div class="details">
                ...
                <?php echo e($booking->flightInstance->schedule->originAirport->name); ?> (<?php echo e($booking->flightInstance->schedule->originAirport->iata_code); ?>) 
                → <?php echo e($booking->flightInstance->schedule->destinationAirport->name); ?> (<?php echo e($booking->flightInstance->schedule->destinationAirport->iata_code); ?>)<br>
                Tanggal: <?php echo e($booking->flightInstance->flight_date->format('d M Y')); ?>

            </div>

            <center>
                <a href="<?php echo e(url('/')); ?>" class="btn">Buka Website Avoinex</a>
            </center>
        </div>
        <div class="footer">
...
<?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/emails/refund_processed.blade.php ENDPATH**/ ?>