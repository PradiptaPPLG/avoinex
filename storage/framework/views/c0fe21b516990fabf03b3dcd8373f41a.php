<?php $__env->startSection('title', 'Continue Booking - Avoinex'); ?>
            ...
            <div class="col-md-8 col-lg-6">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <h5 class="mb-0 fw-bold">
                                <?php echo e($flight->schedule->originAirport->iata_code ?? '---'); ?>

                                <span class="mx-2" style="color:#279ED6;">→</span>
                                <?php echo e($flight->schedule->destinationAirport->iata_code ?? '---'); ?>

                            </h5>
                        </div>
                        <div class="text-end">
                            <span class="avx-auth-label">Date</span>
                            <h6 class="mb-0 fw-bold"><?php echo e($flight->flight_date->format('d M Y')); ?></h6>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="avx-auth-card">
                    ...
                    <div class="avx-auth-body">
                        ...
                        <!-- Option 3: Guest -->
                        <form action="<?php echo e(route('booking.guest')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php if(request('seats')): ?>
                                <input type="hidden" name="seats" value="<?php echo e(request('seats')); ?>">
                            <?php endif; ?>
                            <?php if(request('total')): ?>
                                <input type="hidden" name="total" value="<?php echo e(request('total')); ?>">
                            <?php endif; ?>
                            <?php if(request('flight_id')): ?>
                                <input type="hidden" name="flight_id" value="<?php echo e(request('flight_id')); ?>">
                            <?php endif; ?>
                            <?php if(request('adults')): ?>
                                <input type="hidden" name="adults" value="<?php echo e(request('adults')); ?>">
                            <?php endif; ?>
                            <?php if(request('children')): ?>
                                <input type="hidden" name="children" value="<?php echo e(request('children')); ?>">
                            <?php endif; ?>
                            <?php if(request('infants')): ?>
                                <input type="hidden" name="infants" value="<?php echo e(request('infants')); ?>">
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Avoinex\resources\views/booking/auth.blade.php ENDPATH**/ ?>