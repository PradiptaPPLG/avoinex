...
<header class="avx-topbar">
    <div class="avx-left">
        <a href="/" id="avoinex-logo-link">
            <img src="{{ asset('images/logo_new.png') }}" class="avx-logo">
        </a>
    ...
    <div class="avx-right">
        ...
        @else
            <a href="{{ route('booking.find.form') }}" class="avx-find-booking-btn" id="navbar-find-booking-btn">
...
<footer class="avx-footer">
    <div class="avx-footer-main">
        ...
        <div class="avx-footer-brand">
            <img src="{{ asset('images/logo_new.png') }}" alt="Avoinex">
