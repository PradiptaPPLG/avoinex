...
@section('page-title', 'Tambah Destinasi Populer')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Informasi Destinasi Populer</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.featured_destinations.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-3">
                        <label class="form-label">Nama Destinasi / Judul (misal: Thailand)</label>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Gunakan gambar landscape resolusi tinggi (contoh: 800x400).</small>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select name="origin_iata" class="form-select @error('origin_iata') is-invalid @enderror" required>
                                ...
                                @foreach($airports as $airport)
                                    <option value="{{ $airport->iata_code }}" {{ old('origin_iata') == $airport->iata_code ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="destination_iata" class="form-select @error('destination_iata') is-invalid @enderror" required>
                                ...
                                @foreach($airports as $airport)
                                    <option value="{{ $airport->iata_code }}" {{ old('destination_iata') == $airport->iata_code ? 'selected' : '' }}>
                                        {{ $airport->city }} ({{ $airport->iata_code }})
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" name="starting_price_usd" class="form-control @error('starting_price_usd') is-invalid @enderror" value="{{ old('starting_price_usd') }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="date_range" class="form-control @error('date_range') is-invalid @enderror" value="{{ old('date_range') }}" required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 d-flex align-items-center mt-3">
                            <div class="form-check form-switch pt-2">
                                <input class="form-check-input" type="checkbox" role="switch" name="is_active" id="isActiveCheck" value="1" {{ old('is_active', true) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-end gap-2 border-top pt-3">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i> Simpan Destinasi</button>
                    </div>
                </form>
            </div>
        </div>
