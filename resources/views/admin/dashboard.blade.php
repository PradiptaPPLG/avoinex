    ...
    <div class="col-md-6 col-xl-3 avx-reveal avx-delay-250">
        <div class="stat-card">
            <div>
                ...
                <div class="stat-value" style="font-size:24px;">Rp {{ number_format($totalRevenueIdr, 0, ',', '.') }}</div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(bookingCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Confirmed',
                    data: {!! json_encode($bookingConfirmedData) !!},
                ...
                {
                    label: 'Cancelled',
                    data: {!! json_encode($bookingCancelledData) !!},
    ...
    new Chart(routeCtx, {
        type: 'bar',
        data: {
            labels: {!! json_encode($topRouteLabels) !!},
            datasets: [{
                label: 'Total Bookings',
                data: {!! json_encode($topRouteValues) !!},
