...
@section('title', 'Register Aircraft')
@section('page-title', 'Register Aircraft')
    ...
    <div class="card-body">
        <div class="row g-4">
            <div class="col-md-4">
                ...
                <input type="text" name="registration_number" class="form-control" placeholder="e.g. PK-GEA" value="{{ old('registration_number') }}" required>
            </div>
            <div class="col-md-4">
                <label class="form-label">Aircraft Model</label>
                <input type="text" name="model" class="form-control" placeholder="e.g. Boeing 737-800" value="{{ old('model') }}" required>
            </div>
            <div class="col-md-4">
        ...
        <div class="row g-4 mt-1">
            <div class="col-md-4">
                ...
                <input type="number" name="baggage_capacity_kg" class="form-control" placeholder="e.g. 20" value="{{ old('baggage_capacity_kg', 20) }}" min="0" required>
            </div>
            <div class="col-md-4 d-flex align-items-end">
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="has_meal" id="has_meal" value="1" {{ old('has_meal', true) ? 'checked' : '' }}>
                    <label class="form-check-label ms-2" for="has_meal">Meal Included</label>
                </div>
            </div>
            <div class="col-md-4 d-flex align-items-end">
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input" type="checkbox" name="has_wifi" id="has_wifi" value="1" {{ old('has_wifi') ? 'checked' : '' }}>
    ...
    <div class="card-body">
        ...
        <div style="background: var(--surface-2); border: 1.5px solid var(--border); border-radius: 10px; padding: 18px;">
            <div class="form-check form-switch d-flex align-items-center gap-3 mb-0">
                <input class="form-check-input" type="checkbox" name="preferred_zone_enabled" id="preferred_zone_enabled" value="1" {{ old('preferred_zone_enabled') ? 'checked' : '' }} style="width: 40px; height: 22px;">
                <div>
