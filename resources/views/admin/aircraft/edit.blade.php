...
<div class="d-flex align-items-center gap-3 mb-4">
    <a href="{{ route('admin.aircraft.index') }}" class="btn btn-secondary btn-sm">
        <i class="bi bi-arrow-left me-1"></i> Back
    </a>
    <div style="color: var(--text-muted); font-size: 13px;">Aircraft Management → Edit Aircraft</div>
    <span class="badge bg-primary ms-1" style="font-family:'JetBrains Mono',monospace; font-size: 12px;">{{ $aircraft->registration_number }}</span>
</div>
    ...
    <div class="card-body">
        <div class="row g-4">
            ...
            <div class="col-md-3">
                ...
                <div class="form-control bg-light fw-bold text-primary" id="total_seats_display" style="font-family:'JetBrains Mono',monospace; font-size: 15px;">{{ ($aircraft->seat_columns ?? 6) * ($aircraft->seat_rows ?? 30) }}</div>
    ...
    <div class="card-body">
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4">
                ...
                <div class="form-control bg-light" id="business_seats_display" style="font-family:'JetBrains Mono',monospace;">{{ ($aircraft->seat_columns ?? 6) * ($aircraft->business_rows ?? 2) }}</div>
                <small class="text-muted">Auto-calculated</small>
            </div>
            <div class="col-md-4">
                <label class="form-label">Economy Class Seats</label>
                <div class="form-control bg-light" id="economy_seats_display" style="font-family:'JetBrains Mono',monospace;">{{ $aircraft->economy_seats ?? 168 }}</div>
                <small class="text-muted">Auto-calculated</small>
            </div>
        </div>

        {{-- Preferred Zone Toggle --}}
        <div style="background: var(--surface-2); border: 1.5px solid var(--border); border-radius: 10px; padding: 18px;">
            <div class="form-check form-switch d-flex align-items-center gap-3 mb-0">
                <input class="form-check-input" type="checkbox" name="preferred_zone_enabled" id="preferred_zone_enabled" value="1" {{ old('preferred_zone_enabled', $aircraft->preferred_zone_enabled) ? 'checked' : '' }} style="width: 40px; height: 22px;">
                <div>
            ...
            <div id="preferred_zone_fields" style="display: none; margin-top: 20px; padding-top: 18px; border-top: 1px solid var(--border);">
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-control bg-light" id="preferred_seats_display" style="font-family:'JetBrains Mono',monospace;">0</div>
                        <small class="text-muted">Auto-calculated</small>
                    </div>
                </div>
            </div>
...
<div class="d-flex gap-2">
    <button type="submit" class="btn btn-primary">
        <i class="bi bi-check-lg me-1"></i> Update Aircraft
    </button>
