                ...
                <div class="avx-sort-bar mb-3">
                    <div class="avx-sort-left">
                        <span class="avx-results-count" id="resultsCount">
                            ...
                            <strong>{{ $flights->count() }}</strong> penerbangan ditemukan
                        </span>
                    </div>
                ...
                <div id="flightCardsContainer">
                    @if($flights->isEmpty())
                        <div class="avx-empty-state" id="emptyStateOriginal">
                            ...
                            <a href="{{ route('home') }}" class="btn btn-primary">Pencarian Baru</a>
                        </div>
                    @else
                        ...
                        <div class="flight-card ticket-card avx-flight-item"
                             ...
                             data-depart-hour="{{ $departureHour }}"
                             data-depart-time="{{ $departureTime }}"
                             data-airline="{{ $airlineName }}"
                             data-has-promo="{{ isset($flight->active_flash_sale) ? '1' : '0' }}">
                            <div class="ticket-top p-3">
                                <div class="row align-items-center">
                                    <div class="col-md-2 d-flex flex-column align-items-center gap-2">
                                        @if(isset($flight->schedule->airline->logo_path) && $flight->schedule->airline->logo_path)
                                            <div class="airline-logo rounded-circle shadow-sm overflow-hidden flex-shrink-0" style="background-color: #fff; border: 2px solid #e0e0e0; display: flex; align-items: center; justify-content: center; padding: 0;">
                                                <img src="{{ asset('logo_maskapai/' . $flight->schedule->airline->logo_path) }}" alt="{{ $airlineName }} Logo" style="width: 100%; height: 100%; object-fit: contain; padding: 5px;">
                                            </div>
                                        @else
                                        ...
                                        @endif
                                        <p class="mb-0 fw-bold text-center" style="font-size: 13px;">{{ $airlineName }}</p>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-3 text-center">
                                        <p class="mb-1">{{ floor($durationMinutes / 60) }}h {{ $durationMinutes % 60 }}m</p>
