                ...
                <div class="d-flex h-100">
                    <div class="bg-primary text-white p-3 d-flex flex-column justify-content-center align-items-center" style="width: 100px;">
                        <div class="fw-bold" style="font-size: 1.2rem;">
                            ...
                            @else
                                Rp{{ number_format($coupon->discount_value/1000, 0) }}k
                            @endif
                        </div>
                    ...
                    <div class="p-3 flex-grow-1">
                        ...
                        <p class="text-muted small mb-2" style="font-size: 0.75rem;">Min. spend Rp{{ number_format($coupon->min_spend/1000, 0) }}k</p>
                        <button class="btn btn-sm btn-outline-primary rounded-pill w-100 fw-bold avx-claim-btn" data-code="{{ $coupon->code }}">CLAIM</button>
                    </div>
                </div>
            </div>
        </div>
...
<section class="container mt-5 mb-5 promo-carousel-section">
    <div class="d-flex justify-content-between align-items-center mb-3 px-2">
        ...
        <a href="{{ route('deals') }}" class="text-primary fw-bold text-decoration-none small">Lihat semua <i class="bi bi-chevron-right"></i></a>
    </div>
    
    <div id="promoCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        <div class="carousel-inner rounded-4">
            @foreach($banners->chunk(3) as $chunkIndex => $chunk)
            <div class="carousel-item {{ $chunkIndex == 0 ? 'active' : '' }}">
                <div class="row g-3 px-1">
                    @foreach($chunk as $banner)
                    <div class="col-md-4">
                        <a href="{{ $banner->link_url ?? '#' }}" class="avx-promo-banner-card d-block position-relative overflow-hidden rounded-4">
                            <img src="{{ asset('storage/' . $banner->image_path) }}" class="img-fluid w-100" alt="{{ $banner->title }}" style="height: 200px; object-fit: cover;">
