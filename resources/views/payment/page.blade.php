                ...
                <div class="card-body">
                    <form action="{{ route('payment.process') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-success btn-lg w-100 fw-bold">
                            <i class="bi bi-lock me-2"></i> Pay Now Rp {{ number_format($booking->total_price_usd, 0, ',', '.') }}
                        </button>
                    </form>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border-0 py-1">
                                    ...
                                    <div class="text-muted" style="font-size: 11px; margin-left: 16px;">Seat {{ $seat->seat->seat_number ?? '-' }}</div>
                                </td>
                                <td class="text-end border-0 py-1">Rp {{ number_format($seat->price_at_booking, 0, ',', '.') }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-end border-0 py-0 text-muted" style="font-size: 11px;">+Rp {{ number_format($seat->baggage_price, 0, ',', '.') }}</td>
                            </tr>
                            @endif
                            @endforeach
                        </tbody>
